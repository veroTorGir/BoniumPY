"""
Módulo de graficación para órdenes - BoniumPY
Proporciona funciones para visualizar datos de órdenes mediante gráficos
...
# Ruta por defecto para guardar gráficos de órdenes
...
def graficar_lineas(datos_agrupados, columna_eje_x, columna_eje_y,
    ...
    en el tiempo (ej: órdenes por fecha).
...
def graficar_barras(datos_agrupados, columna_categorias, columna_valores,
    ...
    entre categorías (ej: órdenes por usuario).
...
def graficar_mapa_calor(datos_agrupados, columna_filas, columna_columnas, columna_valores,
    ...
    intensidad por valor (ej: usuarios vs productos).
