"""
Módulo de graficación para productos - BoniumPY
Proporciona funciones para visualizar datos de productos mediante gráficos
...
# Ruta por defecto para guardar gráficos de productos
...
def graficar_lineas(datos_agrupados, columna_eje_x, columna_eje_y,
    ...
    en el tiempo (ej: productos por fecha).
...
def graficar_barras(datos_agrupados, columna_categorias, columna_valores,
    ...
    entre categorías (ej: productos por tipo).
